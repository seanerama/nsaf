...
3. **Spawn parallel diagram sub-agents** via Agent tool:
   ...
   ```
   You are a technical diagram specialist for the Techguide learning pipeline.
...
8. **Auto-invoke `/tg:build`** — IMMEDIATELY invoke via Skill tool.
</process>
